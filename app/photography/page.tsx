  ...
  return (
    <main className="min-h-screen bg-[#00131c]">
      ...
      <div className="relative pt-12 pb-16 text-center">
        ...
        <div className="absolute top-6 left-6 flex h-10 flex-row items-center gap-0 rounded-full border border-[#f0c56d]/30">
          ...
          >
            ...
            <span className="font-medium text-sm">Engineer</span>
          </div>
          <div className="h-5 w-px bg-[#f0c56d]/20" />
          {/* Traveller — active */}
          <div
            className={cn(
          ...
          >
            ...
            <span className="font-medium text-sm">Traveller</span>
          </div>
        </div>
